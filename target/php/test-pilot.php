...
<?php Pontoon::header_tags();?>
	...
	<link rel="stylesheet" type="text/css" media="all" href="http://testpilot.mozillalabs.com/css/screen.css" />
	<link rel="icon" href="http://testpilot.mozillalabs.com/images/favicon.ico"> 
        <script type="text/javascript">
          var s_account="mozillatestpilotmozillalabscom";
        </script><link rel="stylesheet" type="text/css" href="http://testpilot.mozillalabs.com/css/screen.css">
...
<body>
		...
		<div id="container">
			...
			<div id="download"><div id="downloadsource" class="button" onclick="window.location='https://addons.mozilla.org/services/install.php?addon_id=testpilot'"><img class="downloadButton" src="images/download_arrow.png"> <span class="downloadH1"><?= _w('Become a Test Pilot!')?></span> </div></div>
			<div id="content">
			
				<div class="button">
			
					<span class="menuOn"><a href="/index.html"><?= _w('Home')?></a></span>

					<span class="menuItem"><a href="/testcases/"><?= _w('Test Cases')?></a></span>
					<span class="menuItem"><a href="/principles.html"><?= _w('Guiding Principles')?></a></span>
                    <span class="menuItem"><a href="/faq.html"><?= _w('FAQ')?></a></span>
					<span class="menuItem"><a href="/privacy.html"><?= _w('Privacy Policy')?></a></span>
...
<p><?= _w('Once you <a href="https://addons.mozilla.org/services/install.php?addon_id=testpilot"> install the Test Pilot add-on</a>, you will automatically  receive notifications on upcoming and finished studies. You have the full control on your participation: </a>')?>
				  <ul><li><?= _w('You choose if you want to participate in a particular study')?></li>
				    ...
				    <li><?= _w('At the end of a study, you choose if you want to submit your data to the Test Pilot servers')?></li>
...
<p><?= _w('When a product is not easy to use, don\'t just wonder why it\'s designed that way. Make your mark on the design and help us improve it! <a href="https://addons.mozilla.org/services/install.php?addon_id="testpilot"> Join the forces, we want you! </a>')?></p>
 ...
 <div class="home_button"><a href="https://testpilot.mozillalabs.com/faq.html"><?= _w('Learn more about Test Pilot &raquo;')?></a></div>
				</div>
				
				<div id="links">
				
					<div class="home_callout"><img class="homeIcon" src="images/home_computer.png"> <a href="http://labs.mozilla.com/projects/test-pilot/"><?= _w('Test Pilot Blog &raquo;')?></a></div> <br>

					
					<div class="home_callout"><img class="homeIcon" src="images/home_upcoming.png"><a href="https://wiki.mozilla.org/Labs/Test_Pilot"><?= _w('Test Pilot Wiki &raquo;')?></a></div> <br>
					
					<div class="home_callout"><img class="homeIcon" src="images/home_results.png"><a href="https://testpilot.mozillalabs.com/testcases/"><?= _w('All Test Cases &raquo;')?></a></span></div> <br>

					<div class="home_callout"><img class="homeIcon" src="images/home_twitter.png"><a href="http://www.twitter.com/MozTestPilot"><?= _w('@MozTestPilot! &raquo;')?></a></span></div>
